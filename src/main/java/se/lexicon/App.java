...
public class App
{
    public static void main( String[] args )
    {
        ...
        System.out.println(P1.getSummary());
        System.out.println("\n" + LocalDate.now() + "\n");
        TodoItem item1 = new TodoItem("Städa", "Hela jävla huset måste städas noga.", "2024-03-14", P1);
        System.out.println(item1.getSummary());
        item1.setDone(true);
        System.out.println(item1.getSummary());
        TodoItem item2 = new TodoItem("Tvätta", "Alla jävla kläder måste tvättas och strykas.", "2024-03-18", P2);
